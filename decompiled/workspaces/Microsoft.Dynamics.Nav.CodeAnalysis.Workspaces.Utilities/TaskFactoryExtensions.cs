...
internal static class TaskFactoryExtensions
{
	...
	public static Task SafeStartNew(this TaskFactory factory, Action action, CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
	{
		...
		return factory.StartNew(action3, cancellationToken, creationOptions, scheduler);
	}
	...
	public static Task<TResult> SafeStartNew<TResult>(this TaskFactory factory, Func<TResult> func, CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
	{
		Func<TResult> func2 = func;
		Func<TResult> function = delegate
		{
			try
			{
				return func2();
	...
	public static Task SafeStartNewFromAsync(this TaskFactory factory, Func<Task> actionAsync, CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
	{
		Task task = factory.StartNew(actionAsync, cancellationToken, creationOptions, scheduler).Unwrap();
	...
	public static Task<TResult> SafeStartNewFromAsync<TResult>(this TaskFactory factory, Func<Task<TResult>> funcAsync, CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
	{
		Task<TResult> task = factory.StartNew(funcAsync, cancellationToken, creationOptions, scheduler).Unwrap();
